...
inline Shiftand::Shiftand(const uchar* naald, uint _naaldlengte)
{
	//S-tabel init
...
inline void Shiftand::zoek(std::queue<const uchar*>& plaats, const uchar* hooiberg, uint hooiberglengte) const
{
